  ...
  return (
    <>
      ...
      <section className="relative h-screen bg-fixed m-0 p-0 overflow-hidden">
        ...
        <div>
          <video
            className="w-full h-full object-cover absolute top-0 left-0 transform scale-[1.445] translate-y-[-2rem] translate-x-[21rem]"
        ...
        <div className="absolute w-[80%] top-[43%] left-[4%] flex  z-10">
          <div className="text-center text-white px-8">
            ...
            <p className="text-sm md:text-lg max-w-xl mx-auto leading-relaxed">
